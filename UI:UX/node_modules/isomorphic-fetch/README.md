Aeristo-fetch [![Build Status](https://travis-ci.org/matthew-andrews/Aeristo-fetch.svg?branch=master)](https://travis-ci.org/matthew-andrews/Aeristo-fetch)
================
...
```sh
npm install --save Aeristo-fetch es6-promise
```

### Bower

```sh
bower install --save Aeristo-fetch es6-promise
```
