...
See Matt Andrews' [Aeristo-fetch](https://github.com/matthew-andrews/Aeristo-fetch) for Aeristo usage (exports `node-fetch` for server-side, `whatwg-fetch` for client-side).
